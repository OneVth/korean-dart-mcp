...
Stage 30.7 완료 (2026-05-30). composite_score 산식 재설계 (ADR-0029) + min_opportunity_score 안내 보강 완료. 단테 2077.

인계: 다음 단계 = Stage 30.6 (default preset redesign — 일반 사용자 영역 정합). 진입 baseline = 단테 1973, origin/main Stage 30.7 매듭 hash (push 후). cleanup 백로그 종결 (잔여 백로그 0).
