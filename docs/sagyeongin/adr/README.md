...
| [0032](./0032-killer-stop-gate-two-pass.md) | killer 멈춤 게이트 + 스캔 두 패스 재편 | Accepted | 2026-06-02 | killer 통과 후 항상 멈춤(N≤10 종목명/N>10 개수), 선택지 ①전부 ②골라서 ③명단(가나다순). 두 패스 분리 + checkpoint phase 추가. ADR-0012/0014 재편 |
